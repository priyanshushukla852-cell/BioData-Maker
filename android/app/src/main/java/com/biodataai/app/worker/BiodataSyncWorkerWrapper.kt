...
class BiodataSyncWorkerWrapper(
    context: Context,
    params: WorkerParameters
) : CoroutineWorker(context, params) {

    private val database = BioDataDatabase.getInstance(context)
    private val biodataService = RetrofitServiceProvider.getBiodataService()
